...
cd
# Github error coloring
if [[ -d ~/gitstatus ]]; then
  GITSTATUS_LOG_LEVEL=DEBUG
  source ~/gitstatus/gitstatus.prompt.sh
else
  PS1='\[\033[01;32m\]\u@\h\[\033[00m\] '           # green user@host
  PS1+='\[\033[01;34m\]\w\[\033[00m\]'              # blue current working dire$
  PS1+='\n\[\033[01;$((31+!$?))m\]\$\[\033[00m\] '  # green/red (success/error)$
  PS1+='\[\e]0;\u@\h: \w\a\]'                       # terminal title: user@host$
fi
#coloring

export LS_COLORS='rs=0:no=00:mi=00:mh=00:ln=01;36:or=01;31:di=01;34:ow=04;01;34$
